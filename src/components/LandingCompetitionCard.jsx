...
const CompetitionCard = ({ title, description, imageSrc, linkHref }) => {
  return (
    <div className="flex lg:gap-5 gap-2 justify-center items-center flex-col w-72 h-[450px] lg:h-[550px] bg-[#4D3159] backdrop-blur-md px-3 lg:px-6 py-6 lg:py-8 rounded-2xl shadow-xl text-center text-white [box-shadow:0_0_15px_5px_#AC6871,_0_0_75px_5px_#AC6871_inset] ">
      ...
      <Link
        to={linkHref}
        className="font-dm-sans font-bold text-sm lg:text-lg bg-gradient-to-r from-[#F97283] via-[#B247B4] to-[#9323C2] text-white py-3 px-4 rounded-xl custom-button-shadow hover:scale-105 transition duration-300 ease-in-out"
      >
        Lihat Lebih Lanjut
      </Link>
    </div>
