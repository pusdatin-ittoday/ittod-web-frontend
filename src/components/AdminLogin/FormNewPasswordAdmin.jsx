...
const FormNewPasswordAdminWithRouter = (props) => {
    const navigate = useNavigate();
    return <FormNewPasswordAdmin {...props} navigate={navigate} />;
}

class FormNewPasswordAdmin extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            password: "",
...
export default FormNewPasswordAdminWithRouter;