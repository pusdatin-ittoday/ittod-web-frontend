...
import { registerAdmin } from "../../api/admin"; // pastikan path ini benar
...
class FormRegisterAdmin extends React.Component {
  ...
  async handleSubmit(event) {
    ...
    try {
      const response = await registerAdmin(full_name, email, password);
      ...
      const errorMessage =
        error.response?.data?.message || "Gagal registrasi admin.";
