...
const CompetitionCard = ({ title, description, imageSrc }) => {
  return (
    <div className="flex lg:gap-5 gap-2 justify-center items-center flex-col w-72 h-[400px] lg:h-[500px] bg-[#4D3159] backdrop-blur-md px-3 lg:px-6 py-6 lg:py-8 rounded-2xl shadow-xl text-center text-white [box-shadow:0_0_15px_5px_#AC6871,_0_0_75px_5px_#AC6871_inset] ">
