...
const Register = () => {
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(circle at top left, #FDF5B0 0%, #E9E9F0 100%)",
      }}
    >
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-4 md:p-8">
          ...
          <div className="bg-white border-2 md:border-[3px] border-black shadow-[10px_10px_0px_0px_#000000] md:shadow-[14px_14px_0px_0px_#000000] w-full max-w-[460px] p-6 md:p-10 rounded-none my-8">
            ...
            <div className="flex justify-center mb-8">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src =
                    "https://placehold.co/150x50/cccccc/ffffff?text=ITTODAY";
                }}
              />
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col">
                ...
                <div className="relative flex items-center">
                  ...
                  />
                  {/* Simulated Check Icon if Name length >= 2 */}
                  {namaLengkap.trim().length >= 2 && (
                  ...
                  <span className="absolute left-3.5 flex items-center justify-center pointer-events-none">
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M15 12a5 5 0 1 1-10 0 5 5 0 0 1 10 0zm-3 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm3 0h7M18 12v3.5M21 12v3.5"
                      />
                    </svg>
                  </span>
                  <input
            ...
            <div className="flex items-center my-6">
              ...
              <span className="px-4 text-xs font-bold text-black uppercase font-sans">
                ATAU
              </span>
              <div className="flex-grow border-t-2 border-dashed border-black"></div>
            </div>
