...
const FallbackEventCloseRegist = (props) => {
	return (
		<div className="font-dm-sans flex flex-col min-h-screen items-center justify-center h-screen">
			...
			<div className="flex flex-col gap-5 items-center justify-center">
				<h1 className="font-dm-sans input-text-glow text-pink-400 text-5xl font-bold">
					Oops!
				</h1>
				<div className="text-center max-w-md">
					<p className="font-dm-sans text-base md:text-lg leading-relaxed text-pink-100 drop-shadow-[0_0_10px_#ffffff77] mb-3">
						Pendaftaran{" "}
						<span className="font-bold text-pink-300 border-b-2">
							{props.eventName}
						</span>{" "}
						sudah ditutup nih!
					</p>
...
export default FallbackEventCloseRegist;
