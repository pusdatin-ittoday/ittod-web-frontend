        ...
        <main className="flex flex-col flex-grow justify-end">
          <div className="w-full px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
            <div className="max-w-6xl mx-auto bg-[#4D3159] rounded-3xl text-white shadow-[0_0_60px_#AC6871] py-12 px-6 mb-6">
              {/* Judul */}
              <h1 className="text-3xl md:text-4xl font-extrabold mb-4 text-white drop-shadow-[0_0_10px_#ffffff77] text-center md:text-left">CONTACT US</h1>

              {/* Konten isi dan tombol */}
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6">
                {/* Paragraf */}
                <p className="text-base md:text-lg leading-relaxed text-pink-200 drop-shadow-[0_0_10px_#ffffff77] max-w-3xl text-justify md:text-left">
                ...
                <div className="flex flex-col md:flex-row gap-4 items-center justify-center md:justify-end">
                  <button className="bg-gradient-to-r from-[#F97283] via-[#B247B4] to-[#9323C2] text-white py-2 px-6 rounded-xl hover:scale-105 transition duration-300 ease-in-out">Kontak Kami</button>
                </div>
              </div>
            </div>
          </div>
